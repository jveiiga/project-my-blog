      ...
      <main className="container-main__AboutMe">
        <div className="">
          ...
          <p className="container-text-part__two">
            ...
            32 years old, am Paulista and currently reside in the east side.
            Development Study Front end, about a little over a year and a half.
            I have been working on my own projects improving my skills and
